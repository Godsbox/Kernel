 ...
 * @author wsy
 */
public class RatioShapeImageView extends AppCompatImageView {
    ...
    public static final int DEFAULT_ROUND_RADIUS = 10;//默认圆角大小

    /**
     *  数值为dp值
     */
    public static final int ROUND_RADIUS_IMAGE_NORMAL = 3;


    public RatioShapeImageView(Context context) {
        this(context, null, 0);
        initView();
    }

    public RatioShapeImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initView();
    }

    public RatioShapeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRoundRadius = array.getInt(R.styleable.RatioImageView_imageRoundRadius, DEFAULT_ROUND_RADIUS);
        array.recycle();
        initView();
    }
    ...
    public void setRoundRadius(int mRoundRadius) {
        if(this.mRoundRadius != mRoundRadius){
            this.mRoundRadius = DisplayUtils.dp2px(mRoundRadius);
            invalidate();
        }
    }
}
